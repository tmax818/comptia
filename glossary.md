|term|definition|
|---|---|
2.4 GHz | better at propagating through solid surfaces, better range
5 GHz | supports more individual channels and suffers less from congestion and interference
...
802.11a | 5 GHz, 54 Mbps ![][./images/2714-1677002173632.png]
802.11b | 2.4 GHz, 
802.11g | TODO
802.11n | TODO
802.11ac | TODO
...
DVI | Digital Video Interface [DVI]  Legacy video interface that supports digital only or digital and analog signaling. ![][./images/3652-1677002167554.jpg]
...
eSATA | external serial advanced technology attachment [eSATA]  Variant of SATA cabling designed for external connectivity. Less common with new USB
...
headless | cannot be operated directly using input and output devices
...
HDMI standard type A | todo
HDMI mini type C | todo
HDMI micro type D | todo
HDCP | HDMI Digital Content Protection [HDCP] allows a device to validate and authorize a connection.
...
Lightning Cable| Proprietary connector and interface used by Apple iPhone and iPad devices. ![][./images/4639-1677002166085.png]
...
load balancer | Type of switch, router, or software that distributes client requests between different resources, such as communications links or similarly configured servers. This provides fault tolerance and improves throughput. ![][./images/1156-1677002176597.png]
...
PD port | power device port 1500 milliamps or 1.5 amps [7.5W] of power.
...
resource record | Data file storing information about a DNS zone. The main records are as follows: A [maps a host name to an IPv4 address], [AAA]A [maps to an IPv6 address], CNAME [an alias for a host name], MX [the IP address of a mail server], and PTR [allows a host name to be identified from an IP address].
...
SATA | serial Advanced Technology Attachment [SATA] most widely used interface for hard disks on desktop and laptop computers. It uses an L-shaped 7-pin data connector with one device per port and use a new 15-pin power connector, though adapters for the old style 4-pin Molex connectors are available. ![][./images/6464-1677002166155.png]
SATA1 | up to 1500Mb/s = 1.5Gb/s
SATA2 | up to 3000Mb/s = 3Gb/s
SATA3 | up to 6000Mb/s = 6Gb/s device will be the limitation. HD's can't spin fast enough
serial cable [RS-232]  | Legacy bus type using low bandwidth asynchronous serial transmission [RS-232]. Max speed of 115 Kb/s. 
...
Thunderbolt | Thunderbolt can be used as a display interface [like DisplayPort] and as a general peripheral interface [like USB 3]. The latest version uses USB-C connectors. ![][./images/708-1677002166009.jpg]
...
USB 2.0 | 480 Mbps half-duplex, 1.5Mb/s transfer rate. ![][./images/731-1677002165822.png]
USB 3.x | 5 Gb/s [SuperSpeed]full-duplex 
USB types | ![][./images/3969-1677002165877.png]
USB type A | most common 
USB type B | for larger devices 
...
VPN | virtual private network [VPN]  Secure tunnel created between two endpoints connected via an unsecure transport network [typically the Internet]. ![][./images/1225-1677002175774.png]
